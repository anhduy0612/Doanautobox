...
print("toi la duy")
pritn("toi la anh")
print("day la user khong co quyen truy cap")
...
def connect_to_router(router, retries=1):

    """

    Thử kết nối đến router, nếu không thành công sẽ thử lại.
    ...
    while attempt < retries:
        ...
        try:
            ...
            return ConnectHandler(**router)  # Nếu kết nối thành công, trả về ngay lập tức
